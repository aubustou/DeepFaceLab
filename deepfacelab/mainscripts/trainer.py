...
from deepfacelab import models

if TYPE_CHECKING:
    from deepfacelab.models.base import ModelBase
...
def trainer_thread(
    ...
    *,
    ...
    training_data_dst_path: Path,
    pretraining_data_path: Path | None,
    pretrained_model_path: Path | None,
    force_model_name: str | None,
    force_gpu_idxs: list[int] | None,
    cpu_only: bool,
    silent_start: bool,
    execute_programs: list[list[int]],
    debug: bool,
    ...
    def send_preview():
        ...
        event.set()  # Set the GUI Thread as Ready
...
def main(
    ...
    event.wait()  # Wait for inital load to occur.

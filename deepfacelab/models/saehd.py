...
from deepfacelab.models import ModelBase
from deepfacelab.core.leras.optimizers.ada_belief import AdaBelief
from deepfacelab.core.leras.optimizers.rms_prop import RMSprop
from deepfacelab.samplelib.sample_generator_face import SampleGeneratorFace
from deepfacelab.samplelib.sample_processor import SampleProcessor
from deepfacelab.core.leras.models.code_discriminator import CodeDiscriminator
from deepfacelab.core.leras.models.patch_discriminator import UNetPatchDiscriminator
...
class SAEHDModel(ModelBase):
    ...
    def on_initialize_options(self):
        ...
        default_eyes_mouth_prio = self.options["eyes_mouth_prio"] = (
        ...
        if self.is_first_run():
            ...
            self.options["face_type"] = io.input_str(
                ...
                default_face_type,
                ["h", "mf", "f", "wf", "head"],
                help_message="Half / mid face / full face / whole face / head. Half face has better resolution, but covers less area of cheeks. Mid face is 30% wider than half face. 'Whole face' covers full area of face include forehead. 'head' covers full head, but requires XSeg for src and dst faceset.",
            ).lower()
...
""",
    ...
    def on_initialize(self):
        ...
        from deepfacelab.core.leras.archis.deep_fake_archi import DeepFakeArchi

        model_archi = DeepFakeArchi(resolution, use_fp16=use_fp16, opts=archi_opts)
        ...
        with tf.device(models_opt_device):
            ...
            if self.is_training:
                ...
                if self.options["lr_dropout"] in ["y", "cpu"] and not self.pretrain:
                    ...
                    lr_cos = 0
                    lr_dropout = 1.0
                OptimizerClass = AdaBelief if adabelief else RMSprop

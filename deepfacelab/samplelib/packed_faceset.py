...
from deepfacelab.samplelib.sample import Sample
from deepfacelab.samplelib import sample_loader
...
def pack(samples_path):
    ...
    samples = sample_loader.load_face_samples(image_paths)
    ...
    of.write(struct.pack("Q", VERSION))
...
def load(samples_path):
    ...
    for i, sample in enumerate(samples):
        ...
        sample.set_filename_offset_size(
            str(samples_dat_path),
